...
const RESER_PWD_TEMPLATE = fs.readFileSync(path.resolve('src/templates/reset-password.hbs'), 'utf-8');
// console.log(RESER_PWD_TEMPLATE);
...
export async function loginUser(email, password) {
    ...
    return Session.create({
        ...
        accessTokenValidUntil: new Date(Date.now() + 1500 * 60 * 1000), // 15 хвилин
